...
with open(file_to_save, "w") as txt_file:
    ...
    for county_name in county_votes:
        ...
        if (county_results < largest_county_turnout) and (largest_turnout_percentage > winning_percentage):
            largest_county_turnout = county_results
            largest_turnout_votes = county_vote_count
            largest_turnout_percentage = winning_percentage
